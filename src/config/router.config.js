...

  {
    ...
    children: [
      // dashboard
      {
        ...
        redirect: '/dashboard/workplace',
        component: RouteView,
        meta: { title: '仪表盘', keepAlive: true, icon: bxAnaalyse, permission: [ 'SysRole:del' ] },
        children: [
          {
            path: '/dashboard/analysis',
            name: 'Analysis',
            component: () => import('@/views/dashboard/Analysis'),
            meta: { title: '分析页', keepAlive: false, permission: [ 'SysRole:del' ] }
          },
          // 外部链接
          {
          ...
          },
          {
            ...
            meta: { title: '测试功能', keepAlive: true, permission: [ 'SysRole:del' ] }
          }
        ]
      },
